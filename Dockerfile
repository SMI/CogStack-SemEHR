...
RUN pip install urllib3 joblib psycopg2_binary pymongo pyyaml mysql_connector_python pyre2 pydicom pika deepmerge
...
COPY SmiServices-4.0.0-py3-none-any.whl /CogStack-SemEHR/
RUN pip install /CogStack-SemEHR/SmiServices-4.0.0-py3-none-any.whl
